...
def create_sample_data() -> MockDataBuilder:
    ...
    builder.add_account(MockAccountData(
        "Test Broker", "TB789012", 5000.00, is_portfolio=True))
...
def create_test_scenarios() -> Dict[str, MockDataBuilder]:
    ...
    single_account.add_account(MockAccountData(
        "Single Account", "SA001", 1000.00))
    scenarios["single_account"] = single_account

    # High transaction volume scenario
    high_volume = MockDataBuilder()
    high_volume.add_account(MockAccountData(
        "High Volume Bank", "HV001", 10000.00))
    ...
    portfolio.add_account(MockAccountData(
        "Investment Account", "IA001", 50000.00, is_portfolio=True))
